...
function PersonalDetailsForm({ userData }) {
  const { Controller, control, register, post, put, errors, handleSubmit } =
    useForm(userData || {});
        ...
        <div className="col-span-4">
          ...
          <TextField
            {...register("national_id", {
              required: "national_id is required",
            })}
        ...
        <div className="col-start-1 col-span-8">
          ...
          <TextArea
            {...register("present_address", {
              required: "present_address is required",
            })}
        ...
        <div className="col-span-8">
          ...
          <TextArea
            {...register("permanent_address", {
              required: "permanent_address is required",
            })}
